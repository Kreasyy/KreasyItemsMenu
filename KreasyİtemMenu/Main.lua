...
local enemies = {
    ...
    {id = EntityType.ENTITY_WALKINGBOIL, variant = 0, name = "Walkingboil"},
    {id = EntityType.ENTITY_FLY_L2, variant = 0, name = "Fly L2"},
    {id = EntityType.ENTITY_SPIDER_L2, variant = 0, name = "Spider L2"},
    {id = EntityType.ENTITY_SWINGER, variant = 0, name = "Swinger"},
    {id = EntityType.ENTITY_DIP, variant = 0, name = "Dip"},
    {id = EntityType.ENTITY_WALL_HUGGER, variant = 0, name = "Wall Hugger"},
    {id = EntityType.ENTITY_MOM_HEAD, variant = 0, name = "Mom Head"},
    {id = EntityType.ENTITY_GURGLING, variant = 0, name = "Gurgling"},
    {id = EntityType.ENTITY_PSY_TUMOR, variant = 0, name = "Psy Tumor"},
    {id = EntityType.ENTITY_DINGLE, variant = 0, name = "Dingle"},
    {id = EntityType.ENTITY_URIEL, variant = 0, name = "Uriel"},
    {id = EntityType.ENTITY_GABRIEL, variant = 0, name = "Gabriel"},
    {id = EntityType.ENTITY_ROUNDY, variant = 0, name = "Roundy"},
    {id = EntityType.ENTITY_MOMS_DEAD_HAND, variant = 0, name = "Moms Dead Hand"},
    {id = EntityType.ENTITY_DUKIE, variant = 0, name = "Dukie"},
    {id = EntityType.ENTITY_ULCER, variant = 0, name = "Ulcer"},
    {id = EntityType.ENTITY_MEATBALL, variant = 0, name = "Meatball"},
    {id = EntityType.ENTITY_PITFALL, variant = 0, name = "Pitfall"},
    {id = EntityType.ENTITY_MOVABLE_TNT, variant = 0, name = "Movable Tnt"},
    {id = EntityType.ENTITY_HUSH_GAPER, variant = 0, name = "Hush Gaper"},
    {id = EntityType.ENTITY_HUSH_BOIL, variant = 0, name = "Hush Boil"},
    {id = EntityType.ENTITY_GREED_GAPER, variant = 0, name = "Greed Gaper"},
    {id = EntityType.ENTITY_MUSHROOM, variant = 0, name = "Mushroom"},
    {id = EntityType.ENTITY_MR_MINE, variant = 0, name = "MR Mine"},
    {id = EntityType.ENTITY_BUBBLES, variant = 0, name = "Bubbles"},
    {id = EntityType.ENTITY_BOMB_GRIMACE, variant = 0, name = "Bomb Grimace"},
    {id = EntityType.ENTITY_DEEP_GAPER, variant = 0, name = "Deep Gaper"},
    {id = EntityType.ENTITY_SMALL_LEECH, variant = 0, name = "Small Leech"},
    {id = EntityType.ENTITY_BLASTER, variant = 0, name = "Blaster"},
    {id = EntityType.ENTITY_HARDY, variant = 0, name = "Hardy"},
    {id = EntityType.ENTITY_NECRO, variant = 0, name = "Necro"},
    {id = EntityType.ENTITY_BIG_BONY, variant = 0, name = "Big Bony"},
    {id = EntityType.ENTITY_VIS_VERSA, variant = 0, name = "Vis Versa"},
    {id = EntityType.ENTITY_WILLO_L2, variant = 0, name = "Willo L2"},
    {id = EntityType.ENTITY_PON, variant = 0, name = "Pon"},
    {id = EntityType.ENTITY_GAPER_L2, variant = 0, name = "Gaper L2"},
    {id = EntityType.ENTITY_TWITCHY, variant = 0, name = "Twitchy"},
    {id = EntityType.ENTITY_SPIKEBALL, variant = 0, name = "Spikeball"},
    {id = EntityType.ENTITY_SMALL_MAGGOT, variant = 0, name = "Small Maggot"},
    {id = EntityType.ENTITY_ADULT_LEECH, variant = 0, name = "Adult Leech"},
    {id = EntityType.ENTITY_CHARGER_L2, variant = 0, name = "Charger L2"},
    {id = EntityType.ENTITY_GASBAG, variant = 0, name = "Gasbag"},
    {id = EntityType.ENTITY_UNBORN, variant = 0, name = "Unborn"},
    {id = EntityType.ENTITY_MORNINGSTAR, variant = 0, name = "Morningstar"},
    {id = EntityType.ENTITY_DARK_ESAU, variant = 0, name = "Dark Esau"},
    {id = EntityType.ENTITY_ARMYFLY, variant = 0, name = "Armyfly"},
    {id = EntityType.ENTITY_MIGRAINE, variant = 0, name = "Migraine"},
    {id = EntityType.ENTITY_DRIP, variant = 0, name = "Drip"},
    {id = EntityType.ENTITY_CLOGGY, variant = 0, name = "Cloggy"},
    {id = EntityType.ENTITY_POOT_MINE, variant = 0, name = "Poot Mine"},
    {id = EntityType.ENTITY_BUTT_SLICKER, variant = 0, name = "Butt Slicker"},
    {id = EntityType.ENTITY_BABY_BEGOTTEN, variant = 0, name = "Baby Begotten"},
    {id = EntityType.ENTITY_VIS_FATTY, variant = 0, name = "Vis Fatty"},
    {id = EntityType.ENTITY_POOFER, variant = 0, name = "Poofer"},
    {id = EntityType.ENTITY_BALL_AND_CHAIN, variant = 0, name = "Ball And Chain"},
    {id = EntityType.ENTITY_FLESH_DEATHS_HEAD, variant = 0, name = "Flesh Death Head"},
    {id = EntityType.ENTITY_BLASTOCYST_BIG, variant = 0, name = "Blastocyst Big"}, 
    {id = EntityType.ENTITY_BLASTOCYST_MEDIUM, variant = 0, name = "Blastocyst Medium"}, 
    {id = EntityType.ENTITY_BLASTOCYST_SMALL, variant = 0, name = "Blastocyst Small"}, 
    {id = EntityType.ENTITY_EMBRYO, variant = 0, name = "Embryo"}, 
    {id = EntityType.ENTITY_MOTER, variant = 0, name = "Moter"}, 
    {id = EntityType.ENTITY_FISTULA_MEDIUM, variant = 0, name = "Fistula Medium"}, 
    {id = EntityType.ENTITY_FISTULA_SMALL, variant = 0, name = "Fistula Small"}, 
    {id = EntityType.ENTITY_FISTULA_BIG, variant = 0, name = "Fistula Big"},
    {id = EntityType.ENTITY_BONE_WORM, variant = 0, name = "Bone Worm"},
    {id = EntityType.ENTITY_REVENANT, variant = 0, name = "Revenant"},
    {id = EntityType.ENTITY_REVENANT, variant = 1, name = "Quad Revenant"},
    {id = EntityType.ENTITY_POKY, variant = 0, name = "Poky"},
    {id = EntityType.ENTITY_POKY, variant = 1, name = "Slide"},
    {id = EntityType.ENTITY_BONY, variant = 3, name = "Bony"},
    {id = EntityType.ENTITY_HUSH_FLY, variant = 0, name = "Hush Fly"},
    {id = EntityType.ENTITY_HOST, variant = 2, name = "Black Host"},
    {id = EntityType.ENTITY_HUSH, variant = 1, name = "Hush Phase 2"},
    {id = EntityType.ENTITY_MEGA_SATAN, variant = 1, name = "Mega Satan Phase 2"},
    {id = EntityType.ENTITY_HOST, variant = 1, name = "Red Host"},
    {id = EntityType.ENTITY_ULTRA_GREED, variant = 1, name = "Ultra Greedier"},
    ...
    {id = EntityType.ENTITY_HORN, variant = 0, name = "Little Horn"},
    ...
    {id = EntityType.ENTITY_HORSEMAN_HEAD, variant = 0, name = "Horseman Head"}, 
